...
func (b *EthAPIBackend) ParsedBlockByNumber(ctx context.Context, number rpc.BlockNumber) (*model.Block, error) {
	return b.eth.AnalysisProcesser.AnalysisBlock(uint64(number)), nil
}
